...
public class Lezhu extends Spider {
    private static final String siteUrl = "http://www.lezhutv.com";
    private static final String siteHost = "www.lezhutv.com";
    ...
    //详情页URL规则
    private Pattern regexVid = Pattern.compile("/detail/(\\w+).html");
    //播放页URL规则
    private Pattern regexPlay = Pattern.compile("(/play/(\\w+).html)");
    //筛选页URL规则
